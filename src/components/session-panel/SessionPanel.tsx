...
import { DiffView } from '@/components/session-panel/DiffView';
import { LogsView } from '@/components/session-panel/LogsView';
import { PromptPicker } from '@/components/session-panel/PromptPicker';
import { PromptTemplateEditor } from '@/components/session-panel/PromptTemplateEditor';
import { RepoPicker } from '@/components/session-panel/RepoPicker';
