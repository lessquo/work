              ...
              guidance={
                <>
                  ...
                  <Steps>
                    ...
                    <li>
                      Copy the token (starts with <code className={codeCls}>sntrys_…</code>) — Sentry only shows it
                      once.
                    </li>
                  </Steps>
              ...
              guidance={
                <>
                  ...
                  <p className='mt-3 text-xs text-gray-500'>
                    ...
                    — the Jira and Sentry prompts use them to fetch issue context. The only MCP server configured
                    locally is <code className={codeCls}>context7</code> for library docs.
                  </p>
                </>
              }
            />
