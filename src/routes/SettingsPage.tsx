    ...
    <div className='mx-auto max-w-4xl p-6'>
        ...
        guidance={
          <>
            ...
            <Steps>
              ...
              <li>
                ...
                <ul className='mt-1 ml-6 list-disc text-gray-600'>
                  ...
                  <li>
                    <code className={codeCls}>member:read</code> — fetch current user, so resolves auto-assign to you
                  </li>
                </ul>
              </li>
              <li>
            ...
            <p className='mt-3 text-xs text-gray-500'>
              When you resolve an issue, the token's owner is auto-assigned, and if the issue has a linked GitHub PR,
              that URL is posted as a comment on the Sentry issue.
            </p>
          </>
        }
        form={
        ...
        guidance={
          <>
            <p>
              ...
              <code className={codeCls}>query()</code> API in-process — no <code className={codeCls}>claude</code> CLI
              is spawned. The SDK reads the same credentials as the Claude CLI, so you authenticate once with the CLI
            ...
            <Steps>
              ...
              <li>
                Authenticate the first time: run <code className={codeCls}>claude</code> once in any folder and complete
                the login.
              </li>
            </Steps>
            <p className='mt-3 text-xs text-gray-500'>
              ...
              Claude can read, edit, and run anything (shell commands included) without prompting. The blast radius is
              the throwaway clone in <code className={codeCls}>clones/session-&lt;id&gt;/</code>; you still review every
              change via the <b>Diff</b> tab and create the PR yourself.
            </p>
          </>
        }
      />
      ...
      <section className='flex justify-between rounded-md border bg-white p-4'>
        <div className='flex flex-col gap-1'>
          ...
          <p className='text-xs text-gray-500'>All items, sessions, and resources for this source will be deleted.</p>
        </div>
        <button
          onClick={async () => {
