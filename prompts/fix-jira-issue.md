...
1. Fetch the full Jira issue (description, comments, attachments metadata) via the Atlassian MCP before investigating. If you find Slack threads links, fetch them as well.
