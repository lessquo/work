...
3. Edit — make the change. For a bug, prefer the minimal fix. Do not run tests or git. (or, if unsure or you need to make a non-obvious design decision, write `./CLAUDE_NOTES.md` instead).
