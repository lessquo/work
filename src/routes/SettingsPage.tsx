          ...
          guidance={
            <>
              <p>
                ...
                <code className={codeCls}>@anthropic-ai/claude-agent-sdk</code> <code className={codeCls}>query()</code>{' '}
                API in-process — no <code className={codeCls}>claude</code> CLI is spawned. The SDK reads the same
                credentials as the Claude CLI, so you authenticate once with the CLI and the SDK picks it up.
              </p>
              <Steps>
                <li>
              ...
              <p className='mt-3 text-xs text-gray-500'>
                ...
                the throwaway clone in <code className={codeCls}>clones/session-&lt;id&gt;/</code>; you still review
                every change via the <b>Diff</b> tab and create the PR yourself.
              </p>
            </>
          }
        />
